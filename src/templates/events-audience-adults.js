      ...
      <div className="wrapper">
        <div className="events">
          ...
          <section className="container">
            {!events ? <h6>There are currently no Adults events</h6> : (
              events.map(( {node: event}) => (
                event.audience === "Adults" && (
...
export const query = graphql`
  {
    ...
    page: contentfulPage(slug: { eq: "events/audience/adults" }) {
      name
      slug
      settings {
        name
