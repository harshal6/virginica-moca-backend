      ...
      <div className="wrapper">
        <div className="events">
          ...
          <section className="container">
            {!events ? <h6>There are currently no Lecture/Panel events</h6> : (
              events.map(( {node: event}) => (
                event.type === "Lecture/Panel" && (
...
export const query = graphql`
  {
    ...
    page: contentfulPage(slug: { eq: "events/type/lecture-panel" }) {
      name
      slug
      settings {
        name
...
export default LecturePanelEvents