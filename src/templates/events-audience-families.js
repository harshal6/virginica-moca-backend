      ...
      <div className="wrapper">
        <div className="events">
          ...
          <section className="container">
            {!events ? <h6>There are currently no Families events</h6> : (
              events.map(( {node: event}) => (
                event.audience === "Families" && (
...
export const query = graphql`
  {
    ...
    page: contentfulPage(slug: { eq: "events/audience/families" }) {
      name
      slug
      settings {
        name
